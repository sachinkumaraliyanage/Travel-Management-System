...
if(isset($_GET["del"])){
 ...
 ?>
		...
		<center><font  color="Black"  size="7" > Contact Form</font></p></center>

		<div align="center" style="color:#0000FF" ><p><font size="6">
  
    	<h4 >EMail - Wishvamekanayaka@gmailcom</h4>


  

   		 <h4>Phone no : 0767198429</h4>
    	<h4>Address: Sliit,Mihidu mawatha,Kurunagala</h4>
       	</font></p>
</div>
